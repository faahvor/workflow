...
const RequesterPending = ({ searchQuery = "", filterType = "all", onOpenDetail = () => {} }) => {
  ...
  const filtered = (requests || []).filter((req) => {
    ...
    const matchesFilter =
      localFilter === "all" || (req.requestType || "").toLowerCase() === localFilter.toLowerCase();
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      onClick={(e) => { e.stopPropagation(); onOpenDetail(request); }}
