...
const WaybillPreview = forwardRef(
  (
    {
      request = {},
      items = [],
    ...
    // Signatures logic (same as GRN)
    let approvedBySignatures = signaturesPrepared.filter(
      (s) =>
        ...
        <div className="flex justify-center mt-4 mb-2">
          <div className="border border-slate-400 rounded-sm p-2 flex flex-col min-w-[210px]">
            <div
              ...
              style={{ lineHeight: 1 }}
            >
              <span className="mr-2">Req No.:</span>
              <span
